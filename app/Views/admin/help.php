...
<div class="row">
                ...
                <div class="bs-example" data-example-id="simple-jumbotron">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                <ul>
                                    <li>У верхній частині сторінки знаходиться список походів (спочатку може бути пустим). Там також є пошук по назвам, датам та вартості. Для кожного доданого походу відображається "<b>Назва</b>", "<b>Дати</b>", "<b>Вартість</b>", статус "<b>Включений</b>" та кнопки <span class="disabled btn btn-secondary btn-sm"><i class="fa fa-pencil"></i> Редагування</span> та <span class="disabled btn btn-danger btn-sm"><i class="fa fa-trash"></i> Видалення</span></li>
                                    <li>В нижній частині знаходиться форма для додавання походів. В текстовому полі потрібно вказати ссилку на похід в telegra.ph, наприклад "https://telegra.ph/Novij-R%D1%96k-p%D1%96d-Goverloyu-10-16" і натиснути кнопку <span class="disabled btn btn-primary"><i class="fa fa-plus"></i> Додати!</span></li>
                                    <li>Сторінка telegra.ph, на яку веде вказане посилання, має бути оформлена по правилах:
                                        <ul>
                                            ...
                                            <li>Часто буває що в тексті походу є посилання на окрему сторінку teltgra.ph з додатковою інформацією про спорядження або підготовку для походу. Для цього треба скористатись "Допоміжні сторінки => Додати сторінку", докладніше дивись нижче</li>
                                        </ul>
                                    </li>
                                    <li>
                                ...
                                <a class="btn btn-primary" href="<?= site_url('/admin/hike/carpatian') ?>" target="_blank"><i class="fa fa-send"></i> Перейти на сторінку додавання походів (Карпати)</a>
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <p class="card-text">
                                <ul>
                                    ...
                                    <li>В самому низу сторінки розташовані чотири кнопки:
                                        <ul>
                                            <li><span class="disabled btn btn-secondary"><i class="fa fa-arrow-left"></i> Назад</span> - повернення до списку походів</li>
                                            <li><span class="disabled btn btn-danger"><i class="fa fa-flash"></i> Пересканувати</span> - це спеціальна кнопка. Її треба натиснути якщо зробив зміни на сторінці telegra.ph з якої взяти похід. Тоді зроблені зміни попадуть на сайт. По суті теж саме що видалити похід і додати заново. Фото походу також будуть перезавантажені</li>
                                            <li><span class="disabled btn btn-warning"><i class="fa fa fa-rotate-left"></i> Скинути</span> - це скидання ще не збережених змін</li>
                                            <li><span class="disabled btn btn-primary"><i class="fa fa-save"></i> Зберегти</span> - зберігання форми редагування походу</li>
                                        </ul>
                                    </li>
                                </ul>
                                <a class="btn btn-primary" href="<?= site_url('/admin/hike/carpatian') ?>" target="_blank"><i class="fa fa-send"></i> Перейти на сторінку походів (Карпати)</a>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                <ul>
                                    ...
                                    <li>Додаються так само як і походи, тільки немає параметрів притаманних походам. Все інше теж саме - вказуєш посилання на сторінку в telegra.ph, натискаєш кнопку <span class="disabled btn btn-primary"><i class="fa fa-plus"></i> Додати!</span></li>
                                </ul>
                            <a class="btn btn-primary" href="<?= site_url('/admin/dynamic/add') ?>" target="_blank"><i class="fa fa-send"></i> Перейти до допоміжних сторінок</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Редагування сторінок в меню</h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li><a class="close-link"><i class="fa fa-close"></i></a>
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Кожен віджет редагується на окремій вкладці з відповідною назвою. Для редагування внести зміни в текст(и) та/або змінити фото і натиснути <span class="disabled btn btn-success"><i class="fa fa-save"></i> Завантажити / зберегти</span> для збереження змін
                                    </li>
                                </ul>
                                <a class="btn btn-primary" href="<?= site_url('/admin/main') ?>" target="_blank"><i class="fa fa-send"></i> Перейти на сторінку редагування сторінок в меню</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                ...
                                <p>Для збереження внесених змін натиснути кнопку <span class="disabled btn btn-primary"><i class="fa fa-save"></i> Зберегти</span></p>
                                <a class="btn btn-primary" href="<?= site_url('/admin/settings') ?>" target="_blank"><i class="fa fa-send"></i> Перейти на сторінку налаштуваня сайту</a>
                            </p>
                ...
                <div class="bs-example" data-example-id="simple-jumbotron">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                <ul>
                                    <li>Були вжиті заходи для того щоб адмінка працювала на <b>мобільних пристроях</b>, тож пробуй редагувати з телефону )</li>
                                    <li>Будуть питання - звертайся!</li>
                                    <li>Запиши десь <b>пароль від адмінки</b>, щоб не загубити )</li>
                                </ul>
                            </p>
                        </div>
                    </div>
